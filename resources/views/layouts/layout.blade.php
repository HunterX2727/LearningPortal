...
<head>
      ...
      <!-- Facebook and Twitter integration -->
        ...
        <link rel="stylesheet" href="{{asset('bs/css/bootstrap-grid.css')}}">
        <link rel="stylesheet" href="{{asset('bs/css/bootstrap-grid.min.css')}}">
        <link rel="stylesheet" href="{{asset('bs/css/bootstrap-reboot.css')}}">
        <link rel="stylesheet" href="{{asset('bs/css/bootstrap-reboot.min.css')}}">
    ...
    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <!--bootstrap 4.3.1-->
        <script src="{{asset('bs/js/bootstarp.bundle.js')}}"></script>
        <script src="{{asset('bs/js/bootsrap.bundle.min.js')}}"></script>
        <script src="{{asset('bs/js/bootstap.js')}}"></script>
